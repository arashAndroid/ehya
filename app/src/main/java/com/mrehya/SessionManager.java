...
public class SessionManager {
    ...
    public void setLogin(boolean isLoggedIn) {
        ...
        if(!isLoggedIn){
            ...
            editor.commit();
            editorResume.putString("id",null).apply();
        }
        Log.d(TAG, "User login session modified!");
    }
    ...
    public  String set_Resume(String id, String email, String job_title, //String address,
                           ...
                           String province, String martial, //String militarystatus,
        ...
        editorResume.putString("martial",  martial).apply();
    ...
    public Resume get_Resume() throws JSONException {
        ...
        String  martial = prefResume.getString("martial",  null);
        ...
        Resume resume = new Resume( id,  email,  job_title,  slug,  address,  job_status,  certificate,
                province,  martial,  militarystatus,  about_me,  image,  fullname,  link,  sex,
